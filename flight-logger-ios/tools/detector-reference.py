...
def standard_flight(origin=(49.9, 15.0), elev=250, start=1_700_000_000):
    return make(origin, elev, start, [
        Seg(90, speed=8*KT, heading=90),
        Seg(15, speedFrom=8*KT, speedTo=65*KT, heading=90),
        Seg(20, speedFrom=65*KT, speedTo=75*KT, climbFrom=1, climbTo=4, heading=90),
        Seg(150, speed=80*KT, climb=4, heading=90),
        Seg(93, speed=100*KT, heading=90),
        Seg(60, speed=100*KT, heading=0),
        Seg(87, speed=100*KT, heading=270),
        Seg(140, speed=85*KT, climb=-3, heading=270),
        Seg(60, speed=85*KT, climb=-3, heading=180),
        Seg(30, speedFrom=70*KT, speedTo=55*KT, climbFrom=-3, climbTo=0, heading=270),
        Seg(25, speedFrom=55*KT, speedTo=8*KT, heading=270),
        Seg(90, speed=8*KT, heading=270),
        Seg(60, speed=0, heading=270),
    ])


def touch_and_go(origin=(49.9, 15.0), elev=250, start=1_700_000_000):
    return make(origin, elev, start, [
        Seg(60, speed=8*KT, heading=90),
        Seg(15, speedFrom=8*KT, speedTo=65*KT, heading=90),
        Seg(20, speedFrom=65*KT, speedTo=75*KT, climbFrom=1, climbTo=4, heading=90),
        Seg(90, speed=80*KT, climb=3, heading=90),
        Seg(79, speed=90*KT, heading=0),
        Seg(41, speed=90*KT, heading=270),
        Seg(100, speed=80*KT, climb=-3, heading=270),
        Seg(25, speedFrom=70*KT, speedTo=55*KT, climbFrom=-1.2, climbTo=0, heading=90),
        Seg(15, speed=40*KT, heading=90),
        Seg(15, speedFrom=40*KT, speedTo=70*KT, climbFrom=0, climbTo=3, heading=90),
        Seg(90, speed=80*KT, climb=3, heading=90),
        Seg(79, speed=90*KT, heading=180),
        Seg(41, speed=90*KT, heading=270),
        Seg(90, speed=80*KT, climb=-3, heading=270),
        Seg(25, speedFrom=70*KT, speedTo=55*KT, climbFrom=-1.8, climbTo=0, heading=90),
        Seg(25, speedFrom=55*KT, speedTo=8*KT, heading=90),
        Seg(60, speed=8*KT, heading=90),
        Seg(60, speed=0, heading=90),
    ])
